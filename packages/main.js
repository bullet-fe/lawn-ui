...
function install(Vue) {
  const packages = [Popup,Toast,Dialog,actionSheet,pullRefresh,infiniteScroll,lazyImg];
...
export { Popup,Toast,Dialog,actionSheet,pullRefresh,infiniteScroll,lazyImg };
